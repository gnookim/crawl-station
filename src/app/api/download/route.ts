...
export async function GET(request: NextRequest) {
  ...
  const code = [
    ...
    '    files = ["worker.py","handlers/__init__.py","handlers/base.py","handlers/kin.py","handlers/blog.py","handlers/serp.py","handlers/area.py","handlers/deep.py","handlers/rank.py"]',
    "    for f in files:",
